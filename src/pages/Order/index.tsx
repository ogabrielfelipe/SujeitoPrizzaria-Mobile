...
type OrderRouterProp = RouteProp<RouteDatailParams, 'Order'>
...
export default function Order(){
    ...
    useEffect( () => {
        ...
        async function loadProducts() {
            const response = await api.get('/productsbycategory', {
                params: {
    ...
    function handleChangeProduct(product: ProductsProps){
